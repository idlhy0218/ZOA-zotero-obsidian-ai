...
> **Zotero × Obsidian × Gemini AI 연동 학술 논문 자동 요약 파이프라인**  
...
ZOA를 사용하려면 아래 세 가지가 미리 설치되어 있어야 합니다.
...
아닙니다. ZOA는 지정한 폴더에 마크다운(`.md`) 파일을 저장할 뿐이므로, Obsidian이 없어도 요약 파일은 정상적으로 생성됩니다. 다만 Obsidian을 사용하면 ZOA가 자동으로 생성하는 `[[위키링크]]`를 통해 저자·학술지·키워드 간의 연결망을 시각적으로 탐색할 수 있어 훨씬 유용하게 활용할 수 있습니다.
